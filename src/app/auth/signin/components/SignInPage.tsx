    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white pt-20">
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to your Simba Supermarket account</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <button
            ...
            className="w-full border border-gray-300 py-3 rounded-lg hover:bg-gray-50 font-medium flex items-center justify-center gap-3 transition-colors"
          >
